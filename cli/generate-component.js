...
const run = async () => {
  ...
  const filesToCreate = [
    ...
    {
      writePath: `${componentDir}/${componentName}.module.css`,
      templatePath: null,
    },
    {
      writePath: `${componentDir}/${componentName}.stories.tsx`,
      templatePath: `${templateDir}/story.tsx.template`,
    },
    {
      writePath: `${componentDir}/${componentName}.cy.tsx`,
